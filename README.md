...
- **Lessons Learned** — lessons-learned blog. Six posts covering reward shaping, curriculum design, distributed deployment on Windows, input-vector design, a monitoring dashboard that quietly lied to me for 47 minutes, and a silently-miscomputed choice-head log-prob that rode to production for months.
